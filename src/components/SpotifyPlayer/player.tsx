...
export const Player = () => {
    ...
    return (
        <div className="absolute right-4 top-2">
            ...
            <input
                className="h-1 bg-gray-300 rounded-lg appearance-none cursor-pointer range-sm accent-spotify-green [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:bg-spotify-green [&::-webkit-slider-thumb]:rounded-sm [&::-webkit-slider-thumb]:h-[10px] [&::-webkit-slider-thumb]:w-[10px] hover:[&::-webkit-slider-thumb]:bg-violet-300 active:[&::-webkit-slider-thumb]:bg-violet-300"
                disabled={spotifyPlayerState?.paused}
                type="range"
                min={0}
