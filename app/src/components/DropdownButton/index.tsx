...
export const DropdownButton = ({ dropdownOpen, setDropdownOpen, items, dropdownItemsClass, onItemClick, trackUrl }: DropdownProps) => (
    <>
        ...
        <button
            ...
            className="inline-flex items-center text-sm font-medium text-center md:p-2 text-zinc-700 bg-none rounded-lg hover:opacity-50 focus:ring-2 focus:outline-none focus:ring-violet-300"
            type="button">
